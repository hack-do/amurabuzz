...
ActiveRecord::Schema.define(version: 20151203090536) do
  ...
  add_index "tweets", ["origin_id"], name: "index_tweets_on_origin_id", using: :btree
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean  "active",                             default: false
    t.string   "role",                   limit: 255, default: "individual"
  end
